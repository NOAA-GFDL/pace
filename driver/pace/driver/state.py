...
class TendencyState:
    ...
    u_dt: ndsl.util.Quantity = dataclasses.field(
        metadata={
    ...
    v_dt: ndsl.util.Quantity = dataclasses.field(
        metadata={
    ...
    pt_dt: ndsl.util.Quantity = dataclasses.field(
        metadata={
    ...
    @classmethod
    def init_zeros(cls, quantity_factory: ndsl.util.QuantityFactory) -> "TendencyState":
        initial_quantities = {}
...
class DriverState:
    ...
    def load_state_from_restart(
        ...
        communicator = ndsl.util.Communicator.from_layout(
