...
def test_extgrid_equals_generated(request):
    """
    ...
    config_file_path = request.config.getoption("--config_file_path")
    tile_file_base_path = request.config.getoption("--tile_file_base_path")

    with open(
        os.path.join(DIR, "../../../", config_file_path),
        "r",
    ) as ext_f:
    ...
    tile_file = tile_file_base_path + str(tile_num) + ".nc"
