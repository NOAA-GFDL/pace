...
rm *.bak
$MPIRUN_CALL python -m pace.run baroclinic_c12_write_restart.yaml --log-level=ERROR
$MPIRUN_CALL python -m pace.run RESTART/restart.yaml --log-level=ERROR
$MPIRUN_CALL python -m pace.run baroclinic_c12_run_two_steps.yaml --log-level=ERROR
